...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "hr27820574jiaogu@163.com", "HRLIINVGDHSRCCLW");
    }
    ...
    public static void sendEmail(String code,String email) throws Exception {
        EmailSender.subject("我的博客系统-注册验证")
                .from("我的博客系统")
                .text(" "+code+" 十分钟内有效，非本人操作请忽略此邮件。")
                .to(email)
                .send();
    }
}
